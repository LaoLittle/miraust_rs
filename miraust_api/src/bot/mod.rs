...
extern {
    fn bot_find_instance(id: u64) -> RawPointerMut;

    fn bot_get_friend(bot: RawPointer, id: u64) -> RawPointerMut;

    fn bot_get_group(bot: RawPointer, id: u64) -> RawPointerMut;

    fn bot_get_stranger(bot: RawPointer, id: u64) -> RawPointerMut;
}